  ...
  members: [
    {
      ...
      highlights: [
        ...
        'Former securities & futures broker (Series 3, 7, 24, 65, 66)',
        'Built Financial Media Corp from blog to 130+ employees across 5 countries',
        'Sold majority stake to VNR Verlag subsidiary (Dec 2021)',
      ],
    ...
    },
    {
      ...
      highlights: [
        'Built products reaching 60M+ users',
        'Raised $20M+, multiple exits, globally licensed IP',
